...
var TiktokOrder = require('../model/tiktokModel');
...
module.exports = cron.schedule('0 * * * *', async() => {
    try {
        console.log("Tiktok Update Start")
        let shops = await Marketplace.find({ "sts": "1", "fk_channel": "29" });
